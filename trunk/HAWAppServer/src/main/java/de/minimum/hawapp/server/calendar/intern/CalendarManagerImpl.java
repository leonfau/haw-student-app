...
public class CalendarManagerImpl implements CalendarManager{
	...
	public LectureBO createLectureBO(CategoryBO category, String lectureName) {
		...
		return createLectureBO((LectureBO)lecture);
	}
	...
	@Override
	public AppointmentBO createAppointment(LectureBO lecture,
			String appoinmentName, Date begin, Date end) {
		Appointment appointment=new Appointment();
		appointment.setLecture((Lecture)lecture);
		appointment.setBegin(begin);
		appointment.setEnd(end);
		appointment.setName(appoinmentName);
		return createAppointment((AppointmentBO)appointment);
	}
	...
	@Override
	public ChangeMessageBO createChangeMessage(LectureBO lecture,
			Date changeAt, String reason, String what, String fromPerson) {
		...
		return createChangeMessage((ChangeMessageBO)changemsg);
	}
	...
	public Set<SemesterBO> getAllSemesterBO() {
		...
		Set<SemesterBO> set=(Set<SemesterBO>)new HashSet<SemesterBO>(session.createQuery("from Semester").list());
		transaction.commit();
		return set;
	}
