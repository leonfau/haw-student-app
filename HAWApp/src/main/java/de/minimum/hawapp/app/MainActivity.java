...
public class MainActivity extends TabActivity {
	...
	public void onCreate(final Bundle savedInstanceState) {
		...
		spec = tabHost.newTabSpec("Pub")
				.setIndicator("", res.getDrawable(R.drawable.ic_tab_pub))
				.setContent(intent);
		tabHost.addTab(spec);

		intent = new Intent().setClass(this, StisysActivity.class);
		spec = tabHost.newTabSpec("Stisys")
				.setIndicator("", res.getDrawable(R.drawable.ic_tab_stisys))
				.setContent(intent);
		tabHost.addTab(spec);
		...
		tabHost.getTabWidget().getChildAt(0)
				.setBackgroundColor(Color.parseColor("#06091C"));
		...
		tabHost.getTabWidget().getChildAt(4)
				.setBackgroundColor(Color.parseColor("#06091C"));
		tabHost.getTabWidget().getChildAt(5)
				.setBackgroundColor(Color.parseColor("#06091C"));
