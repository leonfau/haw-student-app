...
//	}
	...
	public void testCategoryCreation(){
		...
		Set<? extends CategoryBO> categories=calendarMgr.getAllCategories();
	...
	public void testLectureCreation(){
		...
		Set<? extends LectureBO> categories=calendarMgr.getLecturesFromCategory(newCategory_1.getUuid());
		assertTrue(categories.size()==2);
	...
	public void testAppointmentCreation(){
		...
		Set<? extends AppointmentBO> categories=calendarMgr.getAppointmentsFromLecture(newLecture_1.getUuid());
		assertTrue(categories.size()==2);
	...
	public void testChangeMessageCreation(){
		...
		Set<? extends ChangeMessageBO> categories=calendarMgr.getChangeMessageFromLecture(newLecture_1.getUuid());
		assertTrue(categories.size()==2);
